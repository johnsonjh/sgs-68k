...
/*							*/
/*	@(#) nami.h: version 24.1 created on 10/28/91 at 18:35:57	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)nami.h	24.1	10/28/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
/*	ATT:#ident	"kern-port:sys/nami.h	10.3"		*/
...
#define	NI_RNM_OLD_CHK	0x8	/* rename: take care of oldname */
#define	NI_RNM_NEW_CHK	0x9	/* rename: take care of newname */
#define	NI_SYMLINK	0xa	/* create a symbolic link */

/* Requests to fs_setattr */
#define	NI_CHOWN	0x1	/* change owner */
#define	NI_CHMOD	0x2	/* change mode (permissions and 
				/* ISUID, ISGID, ISVTX) */
#define NI_ACL		0x3	/* acl request */ 
#define NI_FTRUNC	0x4	/* truncate a file */
#define NI_FSYNC	0x5	/* sync a file */
#ifdef	PERF
#define	NI_CHQUANTUM	0x6	/* change quantum size in the inode	  */
#define	NI_CHSLICE	0x7	/* change slice clamp in the inode	  */
#define	NI_CHPRI	0x8	/* change pri clamp value in the inode	  */
#define	NI_CHUSRPRI	0x9	/* change usrpri clamp value in the inode */
#define	NI_CHCPU	0xA	/* change cpupri clamp value in the inode */
#endif	/* PERF */
#define	NI_CHPRIADJ	0xB	/* change pri adj value in the inode	  */
#define	NI_CHFLAGS	0xC	/* change performance flags  in the inode */
