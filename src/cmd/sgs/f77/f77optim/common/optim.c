...
/*							*/
/*	@(#) optim.c: version 25.1 created on 12/2/91 at 17:40:14	*/
/*							*/
...
/*							*/
/*	optim.c	7.1		*/
/*	optim.c: 1.14 5/25/83";	*/

#ident	"@(#)f77/f77optim/common:optim.c	25.1"
...
int Sflag = 0;			/* Print out size of operation */
static int uflag = 0;		/* Unreachable code deleted */
static int wflag = 0;		/* Window peephole trace */
int quickpass = 0;		/* turns off branch optim and prints
				   different label names so that optim
				   can be run again on the output file
				 */
