...
/*							*/
/*	@(#) pftn.c: version 25.1 created on 12/2/91 at 17:43:10	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)pftn.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
/*	END NEW ARIX SCCS HEADER			*/
/*							*/

#ident	"@(#)sgs/comp2/common:pftn.c	1.1"

/*	OLD MOT: pftn.c	7.5		*/
/*static	char	SCCSID[] = "OLD MOT:  pftn.c:	OLD MOT: pftn.c	7.5	";*/
...
# endif
	...
	case STATIC:
		...
		locctr( ilocctr );
	/*******************************************************************/
/* begWed Aug 14 19:06:08 PDT 1985 hanna */
		{ register strchk =BTYPE(p->stype); /* for long struct alignment */
		if( (strchk==UNIONTY)||( strchk==STRTY )||( strchk==ENUMTY) )
			defalign(32);
		else
/* endWed Aug 14 19:06:08 PDT 1985 hanna */
