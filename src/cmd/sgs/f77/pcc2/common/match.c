...
/*							*/
/*	@(#) match.c: version 25.1 created on 12/2/91 at 17:42:53	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)match.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
/*	END NEW ARIX SCCS HEADER			*/
/*							*/

#ident	"@(#)sgs/comp2/common:match.c	1.1"

/*	OLD MOT: match.c	7.3		*/
/*static	char	SCCSID[] = "OLD MOT:  match.c:	OLD MOT: match.c	7.3	";*/
...
int zflag = 0;			/* non-zero to output stin line and cost for
				...
				*/
extern int ASSIFLAG;	/* see cgen.c */
