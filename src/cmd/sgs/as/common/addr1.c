#ident	"@(#)addr1.c	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
/*
1.1	89/06/08 00:39:44 root
date and time created 89/06/08 00:39:44 by root
*/
/*	OLD MOT:addr1.c	7.1		*/
...
/*
 *
 *	The functions "define", "setval", "settyp", "setscl", "settag", "settypq",
	...
	register codebuf *code;
{
	...
	switch (stype){
		...
		/* hanna: Fri Feb  6 07:47:34 PST 1987 */
		default:{
...
/*
 *
 *	"settypq" is a function that deals the typeq 
 *	field in a symbol table entry. It just ignores the field.
 */
...
register codebuf *code;
{
/** for now just return. BUT when debuggers (e.g. SDB, CDB, etc.)
 ** supporting "const" and "volatile" become available, typeq should
 ** get passed on to in the object file symbol table
 **/
/** in fact , under the current scheme, this function never gets
 ** called. See yylex int mach/M68020/parse.y
 **/
	return;
}
