#ident	"@(#)sub2.c	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
...
/* bk: conditionally stuff tables into readonly section */
#ifdef NOTDONE
#define READ_ONLY()	\
		fprintf(fout,"#if defined __STDC__\n" );	\
		fprintf(fout,"const\n" );					\
		fprintf(fout,"#endif /* __STDC__ */\n" );
#else
#define READ_ONLY()
#endif
