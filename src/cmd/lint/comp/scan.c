...
/*							*/
/*	@(#) scan.c: version 25.1 created on 12/2/91 at 16:02:09	*/
/*							*/
...
/*	ATT:#ident	"comp:common/scan.c	1.11"	*/
	
#ident	"@(#)comp:scan.c	25.1"
...
struct lxrdope {
	...
	"union",	AR_U,	0,
	"void",		AR_TY,	VOID, /* tymerge adds FTN */
	"while",	AR_RW,	WHILE,
