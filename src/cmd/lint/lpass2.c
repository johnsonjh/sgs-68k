...
/*							*/
/*	@(#) lpass2.c: version 25.1 created on 12/2/91 at 16:03:04	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)lpass2.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
/*	ATT:#ident	"lint:lpass2.c	1.10"	*/
	
#ident	"@(#)lint:lpass2.c	25.1"
...
# define NSZ 1024 *3 		/* sw0 */
# if pdp11
#	define TYSZ 2500
#	define FSZ 80
# else				/* sw0 */
#	define TYSZ 3*3500 	/* should be 2500 temp fix for mjs */
#	define FSZ 3*150	/* used to be 80 */
# endif
...
chktype( pt1, pt2 ) register ATYPE *pt1, *pt2; 
{
	...
	if( pt2->extra ){ /* constant passed in */
		if((pt2->aty==pt1->aty) && ( sizeof(int) == sizeof(long)) && !pflag ) return( 0 ); /* sw0 */
