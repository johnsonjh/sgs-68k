...
/*							*/
/*	@(#) prs.c: version 25.1 created on 12/2/91 at 17:07:38	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)prs.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
/*	AT&T: #ident	"sccs:cmd/prs.c	6.11"			*/

#ident	"@(#)sccs:prs.c	25.1"
...
#if u370 || u3b || u3b15 || u3b2 || M68020 || m68k
			u.str[3] = *++lp;
			u.str[2] = *++lp;
#else
			u.str[0] = *++lp;
