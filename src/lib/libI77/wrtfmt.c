...
/*							*/
/*	@(#) wrtfmt.c: version 25.1 created on 12/2/91 at 18:43:37	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)wrtfmt.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
/*	ATT:#ident	"libI77:wrtfmt.c	1.9"	*/
	
#ident	"@(#)libI77:wrtfmt.c	25.1"
...
w_ed(p,ptr,len) char *ptr; struct syl *p; ftnlen len;
{
	...
	default:
		fprintf(stderr,"w_ed, unexpected code: %d\n%s\n",
			p->op,fmtbuf);
		abort();
	case I:	return(wrt_I((xint *)ptr,p->p1,len, 10));
	case IM:
		return(wrt_IM((xint *)ptr,p->p1,p->p2,len));
	case O:	return(wrt_I((xint *)ptr, p->p1, len, 8));
	case L:	return(wrt_L((xint *)ptr,p->p1, len));
...
wrt_I(n,w,len, base) xint *n; ftnlen len; register int base;
...
wrt_IM(n,w,m,len) xint *n; ftnlen len;
...
wrt_L(n,len, sz) xint *n; ftnlen sz;
{	int i;
	long x;
