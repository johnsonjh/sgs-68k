...
/*							*/
/*	@(#) rdfmt.c: version 25.1 created on 12/2/91 at 18:43:12	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)rdfmt.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
/*	ATT:#ident	"libI77:rdfmt.c	1.6"	*/
	
#ident	"@(#)libI77:rdfmt.c	25.1"
...
{	int ch;
	...
	default: fprintf(stderr,"rd_ed, unexpected code: %d\n%s\n",
			p->op,fmtbuf);
		abort();
	case I: ch = (rd_I((xint *)ptr,p->p1,len, 10));
		break;
	case IM: ch = (rd_I((xint *)ptr,p->p1,len, 10));
		break;
	case O: ch = (rd_I((xint *)ptr, p->p1, len, 8));
		break;
...
rd_I(n,w,len, base) ftnlen len; xint *n; register int base;
{	long x;
	int sign,ch;
	char s[84], *ps, *qs;
	ps=s; x=0;
