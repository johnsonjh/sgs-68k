#ident	"@(#)ctype.mk	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
PROF=
NONPROF=
...
OBJECTS= \
_ctype.var.o   iscntrl.o      islower.o      isspace.o      tolower.o \
isalnum.o      isdigit.o      isprint.o      isupper.o      toupper.o \
isalpha.o      isgraph.o      ispunct.o      isxdigit.o
