...
/*							*/
/*	@(#) wclrtoeol.c: version 25.1 created on 12/2/91 at 19:29:17	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)wclrtoeol.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
#ifdef	DEBUG
	if (outf)
	    fprintf(outf, "CLRTOEOL: line %d , maxx = %d, firstch = %d, lastch = %d, next firstch %d\n",
			y, maxx - (int) win->_y[y],
