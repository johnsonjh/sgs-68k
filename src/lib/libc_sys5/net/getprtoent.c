#ident	"@(#)getprtoent.c	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
/*
 ...
 */
#ident	"@(#)getprtoent.c	2.3 LAI KNFS for ARETE source"
#ident	"@(#)getprtoent.c	2.2 System V NFS source"
/* 
