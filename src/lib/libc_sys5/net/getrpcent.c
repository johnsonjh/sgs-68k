#ident	"@(#)getrpcent.c	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
/*
 ...
 */
#ident	"@(#)getrpcent.c	3.3 LAI System V NFS Release 3.2/V3	source"
#ifndef lint
#ident	"@(#)getrpcent.c 1.1 86/02/03  Copyr 1984 Sun Micro"
#endif
