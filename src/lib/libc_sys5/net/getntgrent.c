#ident	"@(#)getntgrent.c	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
/*
 ...
 */
#ident	"@(#)getntgrent.c	2.3 LAI KNFS for ARETE source"
#ident	"@(#)getntgrent.c	2.1 System V NFS source"
/* 
