#ident	"@(#)yp_bind.c	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
#ident	"@(#)yp_bind.c	3.1 LAI System V NFS Release 3.0/V3 source"
#ident	"@(#)yp_bind.c	2.6 System V NFS v2.2 source"
#ifndef lint
#ident	"@(#)yp_bind.c 1.11 85/11/19 Copyr 1985 Sun Micro"
#endif
