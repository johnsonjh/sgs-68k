#ident	"@(#)yp_enum.c	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
/*
 ...
 */
#ident	"@(#)yp_enum.c	3.2 LAI System V NFS Release 3.2/V3	source"
#ifndef lint
#ident	"@(#)yp_enum.c 1.5 85/11/19 Copyr 1985 Sun Micro"
#endif
...

{
	...
	if (!retval) {
		*outkeylen = resp.keydat.dsize;
		memcpy(*outkey, resp.keydat.dptr, resp.keydat.dsize);
