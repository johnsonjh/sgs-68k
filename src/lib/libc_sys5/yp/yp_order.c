#ident	"@(#)yp_order.c	25.1	12/2/91 Copyright (c) 1991 by Arix Corp."
/*
 ...
 */
#ident	"@(#)yp_order.c	3.2 LAI System V NFS Release 3.2/V3	source"
#ifndef lint
#ident	"@(#)yp_order.c 1.3 85/11/19 Copyr 1985 Sun Micro"
#endif
...
#ifdef DEBUG
	printf("v1doorder: return YPERR_YPERR\n");
#endif
		return (YPERR_YPERR);
	}
